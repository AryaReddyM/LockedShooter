...
public class TurretConstants {
    ...
    public static final double[] LOGGED_DISTANCES = new double[] {
        ...
        static {
            ...
            TOF_MAP.put(1.409409, 0.162001034483+0.15);
            ...
            TOF_MAP.put(1.822781, 0.185998061224+0.15);
            ...
            TOF_MAP.put(2.088259, 0.209664558233+0.15);
            ...
            TOF_MAP.put(2.338346, 0.224840961538+0.15);
            ...
            TOF_MAP.put(2.527475, 0.234025462963+0.15);
            ...
            TOF_MAP.put(2.787548, 0.299659813031+0.15);

            // SHOT_MAP.put(2.943017, new ShotData(TurretCalculator.linearToAngularVelocity(LinearVelocity.ofBaseUnits(10.95, MetersPerSecond), FlywheelConstants.kFlywheelRadius), Radian.of(0.53)));
            // TOF_MAP.put(2.943017, 0.299659813031+0.15);
            ...
            TOF_MAP.put(3.097655, 0.340711957478+0.15);

            SHOT_MAP.put(3.59677, new ShotData(TurretCalculator.linearToAngularVelocity(LinearVelocity.ofBaseUnits(11.15, MetersPerSecond), FlywheelConstants.kFlywheelRadius), Radian.of(0.59)));
            TOF_MAP.put(3.59677, 0.391724169605+0.15);
            ...
            TOF_MAP.put(3.71836, 0.415232281986+0.15);
            ...
            TOF_MAP.put(4.033556, 0.452388214944+0.15);
            ...
            TOF_MAP.put(4.611542, 0.491398794987+0.15);
            ...
            TOF_MAP.put(5.050931, 0.532803868044+0.15);
            ...
            TOF_MAP.put(5.525151, 0.575355380899+0.15);
            ...
            TOF_MAP.put(5.944625, 0.602508139682+0.15);
            ...
            TOF_MAP.put(6.546274, 0.679576103937+0.15);
        }
