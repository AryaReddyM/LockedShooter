...
public class ClimbConstants {
  ...
  public static final double climbMaxAcceleration = 0;
  public static final double climbCruiseVelocity = 0;
  public static final double climbAllowedProfileError = 0;

  //change later
  public static final boolean climbInverted = false;
  public static final int climbMotorCurrentLimit = 55;
  public static final double climbMotorReduction = 6.48; // ?
